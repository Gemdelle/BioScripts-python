...
class FrogNautral1:
    ...
    def load_frame(self, index):
        if index not in self.frames:
            frame_path = os.path.join("./assets/gifs/frames/frog_neutral_1", f'frog_neutral_1_{index}.png')
    ...
    def update_animation(self):
        if self.visible:
            ...
            self.frame_index = (current_time // Constants.FRAME_DURATION_IN_MILLIS) % 192  # Assuming 200 frames
