...
class Enemy:
    ...
    def load_frame(self, index):
        if index not in self.frames:
            frame_path = os.path.join("./assets/gifs/frames/enemy", f'enemy_{index}.png')
    ...
    def update_animation(self):
        if self.visible:
            ...
            self.frame_index = (current_time // Constants.FRAME_DURATION_IN_MILLIS) % 399  # Assuming 200 frames
