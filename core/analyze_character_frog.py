...
class AnalyzeCharacterFrog:
    ...
    def load_frame(self, index):
        if index not in self.frames:
            frame_path = os.path.join("./assets/gifs/frames/analysis-frog-final", f'analysis-enemy-frog_{index}.png')
    ...
    def update_animation(self):
        ...
        self.frame_index = (current_time // Constants.FRAME_DURATION_IN_MILLIS) % 681  # Assuming 200 frames
