...
class FrogAngry:
    ...
    def load_frames(self):
        frame_index = 1
        while True:
            frame_path = os.path.join("./assets/gifs/frames/frog_angry", f'frog_angry_{frame_index}.png')
            ...
            frame_index += 1
            self.rect.width = Constants.FROG_ANGRY_SIZE
            self.rect.height = Constants.FROG_ANGRY_SIZE
