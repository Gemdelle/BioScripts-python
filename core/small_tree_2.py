...
class SmallTree2:
    def __init__(self):
        self.frames = {}
        self.frame_index = 0
        self.rect = pygame.Rect(0, 0, Constants.SMALL_TREE_2_SIZE, Constants.SMALL_TREE_2_SIZE)
    ...
    def load_frame(self, index):
        if index not in self.frames:
            frame_path = os.path.join("./assets/gifs/frames/small-tree-2", f'small-tree-2_{index}.png')
            if os.path.exists(frame_path):
                surf = pygame.image.load(frame_path).convert_alpha()
                surf = pygame.transform.scale(surf, (Constants.SMALL_TREE_2_SIZE, Constants.SMALL_TREE_2_SIZE))
    ...
    def draw(self, screen, x, y):
        self.rect.x = x + Constants.SMALL_TREE_2_SIZE
        self.rect.y = y + Constants.SMALL_TREE_2_SIZE
