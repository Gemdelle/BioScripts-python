...
class SmallTree2:
    ...
    def load_frames(self):
        frame_index = 1
        while True:
            frame_path = os.path.join("./assets/gifs/frames/small-tree-2", f'small-tree-2_{frame_index}.png')
            ...
            frame_index += 1
            self.rect.width = Constants.SMALL_TREE_2_SIZE
            self.rect.height = Constants.SMALL_TREE_2_SIZE
