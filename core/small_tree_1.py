...
class SmallTree1:
    ...
    def load_frames(self):
        if not self.frames:
            frame_index = 1
            while True:
                frame_path = os.path.join("./assets/gifs/frames/small-tree-1", f'small-tree-1_{frame_index}.png')
                ...
                frame_index += 1
                self.rect.width = Constants.SMALL_TREE_1_SIZE
                self.rect.height = Constants.SMALL_TREE_1_SIZE
