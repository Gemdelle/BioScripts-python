...
class Hole3:
    def __init__(self):
        self.frames = []
        self.frame_index = 0
        self.rect = pygame.Rect(0, 0, Constants.HOLE_SIZE_3, Constants.HOLE_SIZE_3)
    ...
    def draw(self, screen, x, y):
        self.rect.x = x + Constants.HOLE_SIZE_3
        self.rect.y = y + Constants.HOLE_SIZE_3
        surf = pygame.image.load(resource_path("assets\\images\\hole-3.png")).convert_alpha()
        surf = pygame.transform.scale(surf, (Constants.HOLE_SIZE_3, Constants.HOLE_SIZE_3))
