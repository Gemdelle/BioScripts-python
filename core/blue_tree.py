...
class BlueTree:
    ...
    def load_frames(self):
        frame_index = 1
        while True:
            frame_path = os.path.join("./assets/gifs/frames/tree-blue", f'tree-blue_{frame_index}.png')
            ...
            frame_index += 1
            self.rect.width = Constants.BLUE_TREE_SIZE
            self.rect.height = Constants.BLUE_TREE_SIZE
